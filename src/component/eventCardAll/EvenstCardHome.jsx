            ...
            <div className="p-0 flex  mt-5  rounded-lg drop-shadow-2xl  bg-slate-50">
              <div className="flex justify-center rounded-lg flex-col md:flex-row">
                ...
                <div className="p-5 sm:px-7 w-full md:w-[350px] md:px-7 lg:w-[450px] lg:px-10 xl:w-[550px] xl:px-12">
                  ...
                  <div className="">
                    {/* <FacebookShareButton
                      url="http://136.228.158.126:50003/api/events/my_events/"
                      className=" flex flex-row items-center justify-between "
                    >
                      <p className="mr-5 text-blue-500">share to facekbook</p>
                      <ImFacebook2 className=" text-xl text-blue-500" />
                    </FacebookShareButton> */}
                    <FacebookShareButton
                      url={img}
                      quote={titles}
                    ...
                    >
                      <div className=" mr-5 text-blue-800">share to facebook</div>
